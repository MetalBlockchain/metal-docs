...
Consider the following examples (here Gwei or nAVAX is one-billionth of METAL) -
...
1. Let's create a sample transaction on Avalanche Mainnet, in which we will be
   sending 0.1 METAL to a receiver using Core. Four predefined gas settings can
