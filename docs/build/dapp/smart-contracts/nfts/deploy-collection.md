...
Because we're deploying on the Fuji Network, you'll need to get METAL on the Fuji
network. Avalanche has a [Faucet](https://faucet.avax.network/) that drips
test tokens to the address of your choice. If you already have an METAL balance
