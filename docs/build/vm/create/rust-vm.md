...
AvalancheGo searches for and registers VM plugins under the `plugins` [directory](/nodes/configure/metalgo-config-flags.md#--plugin-dir-string).
...
[here](/nodes/configure/metalgo-config-flags.md#virtual-machine-vm-configs).
