...
```bash
export AVALANCHEGO_EXEC_PATH="${GOPATH}/src/github.com/MetalBlockchain/metalgo/build/avalanchego"
export AVALANCHEGO_PLUGIN_PATH="${GOPATH}/src/github.com/MetalBlockchain/metalgo/build/plugins"
```
