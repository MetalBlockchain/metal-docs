...
You should have cloned [AvalancheGo](https://github.com/MetalBlockchain/metalgo) within your `$GOPATH` in
...
`$GOPATH/src/github.com/MetalBlockchain/metalgo/build/plugins/srEXiWaHuhNyGwPUi444Tu47ZEDwxTWrbQiuD7FmgSAQ6X7Dy`
...
```bash
$GOPATH/src/github.com/MetalBlockchain/metalgo/build/plugins/srEXiWaHuhNyGwPUi444Tu47ZEDwxTWrbQiuD7FmgSAQ6X7Dy --version
```
