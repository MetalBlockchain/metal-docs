...
on a local Metal Blockchain Network and the [Tahoe
C-Chain](../../quickstart/tahoe-workflow.md), which is an instance of the EVM.
...
- Basic understanding of [Solidity](https://docs.soliditylang.org) and Metal Blockchain.
- You are familiar with [Metal Blockchain Smart Contract Quickstart](https://github.com/MetalBlockchain/metal-smart-contract-quickstart).
- Basic understanding of the [Metal Blockchain's architecture](../../overview/getting-started/avalanche-consensus.md)
...
In order to deploy contracts, you need to have some METAL. You can get testnet
METAL from the [Metal Faucet](https://faucet.metalblockchain.org), which is an easy
way to get to play around with Metal Blockchain. After getting comfortable with your
...
[`NFT.sol`](https://github.com/MetalBlockchain/metal-smart-contract-quickstart/blob/3fbba0ac28f6420e9be5d2635d5f23693f80127a/contracts/NFT.sol)
...
arguments](https://github.com/MetalBlockchain/metal-smart-contract-quickstart/blob/3ad93abf50fba65e3aab68f23382bcace73968be/contracts/NFT.sol#L13)
of the NFT contract:
...
function](https://github.com/MetalBlockchain/metal-smart-contract-quickstart/blob/0f29cbb6375a1a452579213f688609c880d52c01/contracts/NFT.sol#L17)
...
Upon success, the command line will display the [transaction data](https://tahoe.metaltrace.io/tx/0x4651ae041a481a6eeb852e5300e9be48e66a1d2332733df22d8e75cf460b0c2c).
...
The Tahoe testnet workflow above can be adapted to Mainnet with the following
modifications to the environment variables:

```zsh
export RPC_URL=https://api.metalblockchain.org/ext/bc/C/rpc
export PRIVATE_KEY=<YOUR-PRIVATE-KEY>
```
...
Metal Network Runner and should be used for LOCAL DEVELOPMENT ONLY.

:::

## Summary

Now you have the tools you need to launch a local Metal network, create a
