...
Users interested in experimenting with Avalanche can receive free testnet METAL, allowing them to
...
If there's already an METAL balance greater than zero on Mainnet, 
