...
[here](/nodes/configure/metalgo-config-flags.md#--chain-config-dir-string). If omitted, value
defaults to `$HOME/.metalgo/configs/chains`. This directory can have
...
[here](/nodes/configure/metalgo-config-flags.md#--chain-config-content-string).
