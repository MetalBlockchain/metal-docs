...
pagination_label: Run a Metal Blockchain Node with Amazon Web Services with one click
sidebar_position: 1
---
...
node](https://github.com/MetalBlockchain/metalgo/releases), `v1.9.5 (Dec 22,
...
* Staking End Date: Your METAL tokens will be locked until this date.

* Stake Amount: The amount of METAL to lock for staking. On Mainnet,
the minimum required amount is 2,000 METAL. On Testnet the minimum required
amount is 1 AVAAX.
...
`AddValidatorTx`. It will show details such as the total value of METAL transferred, any 
METAL which were burned, the blockchainID, the blockID, the NodeID of the validator, 
...
* Working directory is at `/home/avalanche/.metalgo/ (and belongs to avalanchego user)`
...
If you run a Subnet, you would also need to place the VM binary into `/home/avalanche/.metalgo/plugins`.
