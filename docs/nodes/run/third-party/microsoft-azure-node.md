...
pagination_label: Run a Metal Blockchain Node with Microsoft Azure
sidebar_position: 2
---

# Run a Metal Blockchain Node with Microsoft Azure
...
Not only does running a validator node enable you to receive rewards in METAL,
...
offering unparalleled decentralization.
...
```text
scp -i C:\Avalanche\avalanche_key.pem -r ubuntu@EnterYourAzureIPHere:/home/ubuntu/.metalgo/staking C:\Avalanche
```
