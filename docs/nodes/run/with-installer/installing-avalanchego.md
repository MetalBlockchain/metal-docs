...
Will attempt to download:
 https://github.com/MetalBlockchain/metalgo/releases/download/v1.1.1/avalanchego-linux-arm64-v1.1.1.tar.gz
...
Plugin directory, for storing subnet VM binaries, is /home/ubuntu/.metalgo/plugins
