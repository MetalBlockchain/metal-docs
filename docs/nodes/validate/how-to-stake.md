---
tags: [Nodes]
description: This section provides documents on how to stake METAL on the Avalanche Network. 
sidebar_label: How to Stake
pagination_label: How to Stake METAL
sidebar_position: 2
---
...
it receives back the METAL tokens it staked. It may receive a reward for helping
...
more about METAL and the mechanics of staking.
...
- The maximum weight of a validator (their own stake + stake delegated to them)
  is the minimum of 3 million METAL and 5 times the amount the validator staked.
  For example, if you staked 2,000 METAL to become a validator, only 8000 METAL
...
- The minimum amount that a validator must stake is 1 METAL
- The minimum amount that a delegator must delegate is 1 METAL
...
Staking Key is created and put in `$HOME/.metalgo/staking/staker.key`. You
...
You do not need to have METAL funds on your validating node. In fact, it's best
