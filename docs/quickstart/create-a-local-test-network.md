...
The Metal Network Runner repository is hosted at [https://github.com/MetalBlockchain/metal-network-runner](https://github.com/MetalBlockchain/metal-network-runner).
...
The below commands assume you have [MetalGo](../nodes/build/run-metal-node-manually.md#download-metalgo) installed at `$GOPATH/src/github.com/MetalBlockchain/metalgo`. Each of the five nodes created is a validator. The staking keys for these nodes are in `$GOPATH/src/github.com/MetalBlockchain/metalgo/staking/local/staker1.crt`, etc.
