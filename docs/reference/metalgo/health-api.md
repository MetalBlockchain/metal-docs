...
# Health API
  :::tip
  This page was generated by a plugin that directly references this [file](https://github.com/MetalBlockchain/metalgo/tree/master/api/health/service.md)
...
The frequency at which health checks are run can be specified with the [--health-check-frequency](/nodes/configure/metalgo-config-flags.md) flag.
