...
# Index API
  :::tip
  This page was generated by a plugin that directly references this [file](https://github.com/MetalBlockchain/metalgo/tree/master/indexer/service.md)
...
[--index-enabled](/nodes/configure/metalgo-config-flags.md#apis) to true. **AvalancheGo
...
[here](https://pkg.go.dev/github.com/MetalBlockchain/metalgo/indexer#Client). This client can be used
