...
# X-Chain API
  :::tip
  This page was generated by a plugin that directly references this [file](https://github.com/MetalBlockchain/metalgo/tree/master/vms/avm/service.md)
...
Deprecated as of [**v1.9.12**](https://github.com/MetalBlockchain/metalgo/releases/tag/v1.9.12).
...
- `to` is the address the METAL is sent to. This must be the same as the `to` argument in the
...
- Sends `amount` units of asset with ID `assetID` to address `to`. `amount` is denominated in the
  smallest increment of the asset. For METAL this is 1 nAVAX (one billionth of 1 METAL.)
...
Endpoint deprecated as of [**v1.9.12**](https://github.com/MetalBlockchain/metalgo/releases/tag/v1.9.12).
