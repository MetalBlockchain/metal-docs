...
ChainIDs such as 1 (Ethereum) and others as those may cause issues with other
tools.

### Token Symbol

Enter a string to name your Subnet's native token. The token symbol doesn't necessarily need to be unique.
Example token symbols are METAL, XPR, and BTC.
...
![Import MetaMask Account]((/img/metamask-import-1.png)
