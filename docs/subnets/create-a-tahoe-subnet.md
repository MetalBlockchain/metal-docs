...
If you are looking for the previous version using Subnet-CLI, please click [here](./create-a-tahoe-subnet-subnet-cli.md).
...
Chains. Subnet-EVM is a simplified version of [Avalanche C-Chain](https://github.com/MetalBlockchain/coreth).
...
[Run an Metal Node Manually](../nodes/build/run-metal-node-manually.md#connect-to-tahoe-testnet)
...
[this tutorial](https://metalstaking.com/how-to-transfer-cross-chain-in-the-metal-wallet)).
...
To get your new Subnet information, visit [Avascan Testnet](https://tahoe-explorer.metalblockchain.org/). The
...
including the public API server `https://api.metalblockchain.org/`, to connect to MetaMask.
