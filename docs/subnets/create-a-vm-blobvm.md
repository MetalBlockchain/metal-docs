...
[the BlobVM](https://github.com/MetalBlockchain/blobvm). The BlobVM is a virtual machine that can be used
...
- [`vm`](https://github.com/MetalBlockchain/blobvm/tree/master/vm)
  - `block_builder.go`
  - `chain_vm.go`
  - `network.go`
  - `service.go`
  - `vm.go`
- [`chain`](https://github.com/MetalBlockchain/blobvm/tree/master/chain)
  - `unsigned_tx.go`
  - `base_tx.go`
  - `transfer_tx.go`
  - `set_tx.go`
  ...
  - `storage.go`
  - `builder.go`
- [`mempool`](https://github.com/MetalBlockchain/blobvm/tree/master/mempool)
  - `mempool.go`
...
- [TransferTx](https://github.com/MetalBlockchain/blobvm/blob/master/chain/transfer_tx.go) - Transfers coins
between accounts.
- [SetTx](https://github.com/MetalBlockchain/blobvm/blob/master/chain/set_tx.go) - Stores a key-value pair
on the blockchain.

#### UnsignedTransaction

All transactions in the BlobVM implement the common
[`UnsignedTransaction`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/unsigned_tx.go)
...
Common functionality and metadata for transaction types are implemented by [`BaseTx`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/base_tx.go).

- [`SetBlockID`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/base_tx.go#L26) sets the
transaction's block ID.
- [`GetBlockID`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/base_tx.go#L22) returns the
transaction's block ID.
- [`SetMagic`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/base_tx.go#L34) sets the magic
number. The magic number is used to differentiate chains to prevent replay attacks
- [`GetMagic`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/base_tx.go#L30) returns the magic
number. Magic number is defined in genesis.
- [`SetPrice`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/base_tx.go#L42) sets the price
per fee unit for this transaction.
- [`GetPrice`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/base_tx.go#L38) returns the price
for this transaction.
- [`FeeUnits`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/base_tx.go#L59) returns the fee
units this transaction will consume.
- [`LoadUnits`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/base_tx.go#L63) identical to `FeeUnits`
- [`ExecuteBase`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/base_tx.go#L46) executes
...
[`TransferTx`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/transfer_tx.go#L16) supports the
...
implements its own [`Execute`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/transfer_tx.go#L26)
...
[`FeeUnits`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/set_tx.go#L48) method to
...
`SetTx`'s [`Execute`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/set_tx.go#L21) method
...
signature in [`Transaction`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/tx.go). In BlobVM,
...
- Calculate the [digest hash](https://github.com/MetalBlockchain/blobvm/blob/master/chain/tx.go#L41) for
the transaction.
...
- [Sign](https://github.com/MetalBlockchain/blobvm/blob/master/chain/crypto.go#L17) the digest hash with
...
The [mempool](https://github.com/MetalBlockchain/blobvm/blob/master/mempool/mempool.go) is a buffer of
...
[initialization](https://github.com/MetalBlockchain/blobvm/blob/master/vm/vm.go#L151) of VM.
...
[mempool](https://github.com/MetalBlockchain/blobvm/blob/master/vm/vm.go#L431).
...
[`Add`](https://github.com/MetalBlockchain/blobvm/blob/master/mempool/mempool.go#L43) is called. This
...
The [`TimeBuilder`](https://github.com/MetalBlockchain/blobvm/blob/master/vm/block_builder.go)
...
The [`Gossip`](https://github.com/MetalBlockchain/blobvm/blob/master/vm/block_builder.go#L183) method
initiates the gossip of new transactions from the mempool at periodically as defined by `vm.config.GossipInterval`.

#### Build

The [`Build`](https://github.com/MetalBlockchain/blobvm/blob/master/vm/block_builder.go#L166) method
...
[Network](https://github.com/MetalBlockchain/blobvm/blob/master/vm/network.go) handles the workflow of
...
A [`StatefulBlock`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/block.go#L26) contains
...
[StatelessBlock](https://github.com/MetalBlockchain/blobvm/blob/master/chain/block.go#L39) is a superset of
...
[`block.NewBlock`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/block.go#L52) function to
...
[`init`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/block.go#L112) method, which
...
[`Verify`](https://github.com/MetalBlockchain/blobvm/blob/master/chain/block.go#L227) method to validate
...
[Service](https://github.com/MetalBlockchain/blobvm/blob/master/vm/public_service.go) implements an API
server so users can interact with the VM. The VM implements the interface method
[`CreateHandlers`](https://github.com/MetalBlockchain/blobvm/blob/master/vm/vm.go#L265) that exposes the
VM's RPC API.
...
[`IssueRawTx`](https://github.com/MetalBlockchain/blobvm/blob/master/vm/public_service.go#L63) to allow
...
[Initialize](https://github.com/MetalBlockchain/blobvm/blob/master/vm/vm.go#L92) is invoked by `metalgo`
...
- `configBytes` - The serialized VM-specific [configuration](https://github.com/MetalBlockchain/blobvm/blob/master/vm/config.go#L10)
...
[`GetBlock`](https://github.com/MetalBlockchain/blobvm/blob/master/vm/vm.go#L318) returns the block with
the provided ID.
...
[`ParseBlock`](https://github.com/MetalBlockchain/blobvm/blob/master/vm/vm.go#L353) deserializes a block.
...
Avalanche consensus calls [`BuildBlock`](https://github.com/MetalBlockchain/blobvm/blob/master/vm/vm.go#L377)
...
[`SetPreference`](https://github.com/MetalBlockchain/blobvm/blob/master/vm/vm.go#L437) sets the block ID
...
[LastAccepted](https://github.com/MetalBlockchain/blobvm/blob/master/vm/vm.go#L445) returns the block ID of
...
You can learn more about the BlobVM by referencing the [
  README](https://github.com/MetalBlockchain/blobvm/blob/master/README.md) in the GitHub repository.
