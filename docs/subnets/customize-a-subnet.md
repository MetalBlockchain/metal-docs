...
A blockchain created by or forked from [Subnet-EVM](https://github.com/MetalBlockchain/subnet-evm) can be
...
- [Chain Configs](#metalgo-chain-configs)
...
[networks folder](https://github.com/MetalBlockchain/subnet-evm/blob/master/networks/testnet/11111/genesis.json).
...
- [scripts/run.sh](https://github.com/MetalBlockchain/subnet-evm/blob/master/scripts/run.sh#L99)
...
need to update their EVM [chain config](#metalgo-chain-configs) with the following to specify where
...
The `AllowList` solidity interface is defined as follows, and can be found in [IAlowList.sol](https://github.com/MetalBlockchain/subnet-evm/blob/5faabfeaa021a64c2616380ed2d6ec0a96c8f96d/contract-examples/contracts/IAllowList.sol):
...
coin (in METAL), you need to pass 1 \* 10^18 as the amount.
...
[IFeeManager.sol](https://github.com/MetalBlockchain/subnet-evm/blob/5faabfeaa021a64c2616380ed2d6ec0a96c8f96d/contract-examples/contracts/IFeeManager.sol):
...
directly in Remix). It can be also found in
[IRewardManager.sol](https://github.com/MetalBlockchain/subnet-evm/blob/5faabfeaa021a64c2616380ed2d6ec0a96c8f96d/contract-examples/contracts/IRewardManager.sol):
...
project with tests, tasks. For more information see [contract examples README](https://github.com/MetalBlockchain/subnet-evm/tree/master/contract-examples#subnet-evm-contracts).
...
[`config.json`](#metalgo-chain-configs) resides: `{chain-config-dir}/{blockchainID}/upgrade.json`.
For example, `WAGMI Subnet` upgrade should be placed in
`~/.metalgo/configs/chains/2ebCneCbwthjQ1rYT41nhd7M76Hc6YmosMAQrTFhBq8qeqh6tt/upgrade.json`.
...
[Metal Specific APIs](../nodes/maintain/chain-config-flags.md#enabling-metal-specific-apis).
