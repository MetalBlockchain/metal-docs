...
- A Subnet and EVM blockchain has been created. Metal tools allow users to do this on
  [Mainnet](../subnets/subnet-cli), [Tahoe](../subnets/create-a-tahoe-subnet) or a [Local
...
- [metal-smart-contract-quickstart](https://github.com/MetalBlockchain/metal-smart-contract-quickstart)
- [metal-network-runner](../quickstart/create-a-local-test-network#metal-network-runner)
  (Local Workflow)
...
address](../apis/metalgo/apis/issuing-api-calls#endpoints).
...
EVM](https://docs.metalblockchain.org/dapps/smart-contracts/using-hardhat-with-the-metal-c-chain#interact-with-smart-contract).
...
can send assets to your Safe the same way you would send METAL using
...
excerpt](../subnets/create-a-tahoe-subnet#connect-with-metamask).
...
For this part of the tutorial, we will need to clone the [Metal Smart Contract Quickstart
repository](https://github.com/MetalBlockchain/metal-smart-contract-quickstart/tree/proxy-contract-implementation)
and switch to the `proxy-contract-implementation` branch the by running the following Commands:

```zsh
git clone https://github.com/MetalBlockchain/metal-smart-contract-quickstart
...
[`transferProxyOwnership.ts`](https://github.com/MetalBlockchain/metal-smart-contract-quickstart/blob/proxy-contract-implementation/scripts/transferProxyOwnership.ts)
script.
...
[`StorageV2`](https://github.com/MetalBlockchain/metal-smart-contract-quickstart/blob/076f191ca74cd1d15304f7fb945aa53e860ab506/contracts/StorageV2.sol),
an upgraded version of our
[`Storage`](https://github.com/MetalBlockchain/metal-smart-contract-quickstart/blob/076f191ca74cd1d15304f7fb945aa53e860ab506/contracts/Storage.sol)
contract:
...
- `to` - Should be set to the proxy admin address found in
  `metal-smart-contract-quickstart/.openzeppelin/"<YOUR-NETWORK-SESSION>".json`.
...
First, navigate back to hardhat console in your `metal-smart-contract-quickstart-project` and
...
[`increment`](https://github.com/MetalBlockchain/metal-smart-contract-quickstart/blob/964129dfb7cb9271b396927e9ea8b009e321cda1/contracts/StorageV2.sol#L24-L27)
...
[`metal network status`](../subnets/create-a-local-subnet#checking-network-status). In this
