...
or Subnet that is going live on the main network (Mainnet). For
example, [Tahoe](../quickstart/tahoe-workflow) network is the Testnet for Metal's Mainnet.

Besides Tahoe Testnet, [Metal Faucet](https://faucet.metalblockchain.org/) can be used to get free coins
on other testnets Subnets like -

You can use this [repository](https://github.com/MetalBlockchain/metal-faucet) to deploy your faucet or
just make a PR with the
[configurations](https://github.com/MetalBlockchain/metal-faucet/blob/main/config.json) of the Subnet.
...
A [Faucet](https://faucet.metalblockchain.org/) powered by Metal for Tahoe Network and other Subnets.
You can -

- Request test coins for the supported Subnets
- Integrate your EVM Subnet with the faucet by making a PR with the [chain
  configurations](https://github.com/MetalBlockchain/metal-faucet/blob/main/config.json)
- Fork the [repository](https://github.com/MetalBlockchain/metal-faucet) to deploy your faucet for any
  EVM chain

## Adding a New Subnet

You can also integrate a new Subnet on the live [faucet](https://faucet.metalblockchain.org) with just a
few lines of configuration parameters. All you have to do is make a PR on the [Metal
Faucet](https://github.com/MetalBlockchain/metal-faucet) git repository with the Subnet's information.
...
[config.json](https://github.com/MetalBlockchain/metal-faucet/blob/main/config.json) file and make a
PR.

## Building and Deploying a Faucet

You can also deploy and build your faucet by using the [Avalanche
Faucet](https://github.com/MetalBlockchain/metal-faucet) repository.
...
your chain configuration as shown below in the `evmchains` object. Configuration for Tahoe's C-Chain
...
"evmchains": [
    ...
    },
    {
        ...
        "NAME": "WAGMI Testnet",
        "TOKEN": "WGM",
        "RPC": "https://wagmi.metalblockchain.org/wagmi/wagmi-chain-testnet/rpc",
        "CHAINID": 11111,
        "EXPLORER": "https://wagmi.metalblockchain.org/wagmi/wagmi-chain-testnet/explorer",
        "IMAGE": "/wagmi.png",
        "MAX_PRIORITY_FEE": "2000000000",
        "MAX_FEE": "100000000000",
        "DRIP_AMOUNT": 2000000000,
...
example, with the above configurations, the faucet will send `1 METAL` with maximum fees per gas
...
[here](https://github.com/MetalBlockchain/metal-faucet/blob/23eb300635b64130bc9ce10d9e894f0a0b3d81ea/middlewares/rateLimiter.ts#L25).
...
test by the users
[here](https://github.com/MetalBlockchain/metal-faucet/blob/23eb300635b64130bc9ce10d9e894f0a0b3d81ea/middlewares/verifyCaptcha.ts#L20).
...
### Visit Metal Faucet Site

Go to <https://faucet.metalblockchain.org>. You will see various network parameters like network name, faucet
...
This is not just it. You can go to the Subnet explorer or add the
...
[Telegram Developer Channel](https://t.me/metaldevelopers).
...
- **Timeout of 10000ms exceeded** There could be many reasons for this message. It could be an
  ...
  [Telegram Developer Channel](https://t.me/metaldevelopers) server.
