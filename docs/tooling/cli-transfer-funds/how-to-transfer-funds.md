...
import operation fee, which comes out to 0.004 METAL. You can find more
...
- Source address: ledger A, index 2 (the web wallet shows 4.5 METAL for this ledger)
- Target address: ledger B, index 0 (the web wallet shows 0 METAL for this ledger)
...
After confirming with a web wallet that 4.5 METAL is available on p-chain address 
...
The address `P-avax10an3cucdfqru984pnvv6y0rspvvclz63e523m0` has 4.5 METAL and
...
Enter the amount of METAL to send to the recipient. This amount does not include fees.
...
```text
✗ Amount to send (METAL units): 4.496
```
...
- send 4.496000000 METAL from P-avax10an3cucdfqru984pnvv6y0rspvvclz63e523m0 to target address P-avax1r4aceznjkz8ch4pmpqrmkq4f3sl952mdrdt6xm
- take a fee of 0.004000000 METAL from source address P-avax10an3cucdfqru984pnvv6y0rspvvclz63e523m0
...
```text
this operation is going to:
- receive 4.496000000 METAL at target address P-avax1r4aceznjkz8ch4pmpqrmkq4f3sl952mdrdt6xm:
